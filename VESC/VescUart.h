...
class VescUart
{
	...
	public:
		 ...
		 */
		VescUart(VescStream* port, uint32_t timeout_ms = 100);
       ...
       /** Variable to hold firmware version */
         ...
         */
        void setSerialPort(VescStream* port);

        /**
         * @brief      Set the serial port for debugging
         * @param      port  - Reference to Serial port (pointer) 
         */
        void setDebugPort(VescStream* port);
        ...
        void setDuty(int32_t duty, uint8_t canId);
        /**
