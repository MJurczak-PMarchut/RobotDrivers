...
//	#define LEFT_MOTOR_INVERT_DIRECTION
	...
	#define XSHUT_PINS  {TOF_LP3_Pin, TOF_LP5_Pin, TOF_LP5_Pin}
	#define TOFx_GPIO_PINS {TOF_INT3_Pin, TOF_INT5_Pin, TOF_INT5_Pin}
	#define TOFx_XSHUT_PORTS  {TOF_LP3_GPIO_Port, TOF_LP5_GPIO_Port, TOF_LP5_GPIO_Port}
	#define OPPONENT_SEARCH_SPEED 500
	#define OPPONENT_CHASE_SPEED 600
	#define ROBOT_FULL_SPEED 600
	#define DETECTION_THRESHOLD 800
